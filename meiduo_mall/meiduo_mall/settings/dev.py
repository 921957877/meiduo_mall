...
SECRET_KEY = '=x+t*3j9pb6o&-7zwexp1z*s)gn%go#^mb)*_df=2bl^f*y#q2'
...
# 发送邮件的邮箱
EMAIL_HOST_USER = '13917388741@163.com'
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = 'a13564574597'
# 收件人看到的发件人
...
FDFS_URL = 'http://192.168.177.134:8888/'
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.82.133:9200/',  # Elasticsearch服务器ip地址，端口号固定为9200
